...
namespace AviFile
{
	public class VideoStream : AviStream
	{
        ...
        public static bool isWritingAvi = false;
        ...
        private void CreateStreamWithoutFormat() {
            ...
            strhdr.fccHandler = Avi.mmioStringToFOURCC("DIVX", 0);
            strhdr.dwFlags = 0;
            strhdr.dwCaps = 0;
            strhdr.wPriority = 0;
            strhdr.wLanguage = 0;
		...
		private void CreateCompressedStream(){
			...
			opts.fccHandler      = (UInt32)Avi.mmioStringToFOURCC("DIVX", 0);
		...
		private void SetFormat(IntPtr aviStream){
            ...
            bi.biWidth = 640;// width;
            bi.biHeight = 480;// height;
			bi.biPlanes    = 1;
